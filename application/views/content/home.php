    ...
    <div class="container pt-10 pt-md-14 pb-14 pb-md-16 text-center">
        <div class="row gx-lg-8 gx-xl-12 gy-10 gy-xl-0 mb-14 align-items-center">
            <div class="col-lg-7 order-lg-2">
                <figure><img class="img-auto" src="<?= base_url('assets') ?>/img/illustrations/i21.png" srcset="<?= base_url('assets') ?>/img/illustrations/i21@2x.png 2x" alt="" /></figure>
            </div>
            <!-- /column -->
        ...
        <div class="row row-cols-4 row-cols-md-4 row-cols-lg-7 row-cols-xl-7 gy-10 mb-2 d-flex align-items-center justify-content-center">
            <div class="col"><img class="img-fluid px-md-3 px-lg-0 px-xl-2 px-xxl-5" src="<?= base_url('assets') ?>/img/brands/c1.png" alt="" /></div>
            <div class="col"><img class="img-fluid px-md-3 px-lg-0 px-xl-2 px-xxl-5" src="<?= base_url('assets') ?>/img/brands/c2.png" alt="" /></div>
            <div class="col"><img class="img-fluid px-md-3 px-lg-0 px-xl-2 px-xxl-5" src="<?= base_url('assets') ?>/img/brands/c3.png" alt="" /></div>
            <div class="col"><img class="img-fluid px-md-3 px-lg-0 px-xl-2 px-xxl-5" src="<?= base_url('assets') ?>/img/brands/c4.png" alt="" /></div>
            <div class="col"><img class="img-fluid px-md-3 px-lg-0 px-xl-2 px-xxl-5" src="<?= base_url('assets') ?>/img/brands/c5.png" alt="" /></div>
            <div class="col"><img class="img-fluid px-md-3 px-lg-0 px-xl-2 px-xxl-5" src="<?= base_url('assets') ?>/img/brands/c6.png" alt="" /></div>
            <div class="col"><img class="img-fluid px-md-3 px-lg-0 px-xl-2 px-xxl-5" src="<?= base_url('assets') ?>/img/brands/c7.png" alt="" /></div>
        </div>
        <!-- /.row -->
    </div>
    <!-- /.container -->
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-11 px-xxl-5 text-center d-flex align-items-end">
            <div class="col-lg-4">
                <div class="px-md-15 px-lg-3">
                    <figure class="mb-6"><img class="img-fluid" src="<?= base_url('assets') ?>/img/illustrations/i24.png" srcset="<?= base_url('assets') ?>/img/illustrations/i24@2x.png 2x" alt="" /></figure>
                    <h3>Web Design</h3>
            ...
            <div class="col-lg-4">
                <div class="px-md-15 px-lg-3">
                    <figure class="mb-6"><img class="img-fluid" src="<?= base_url('assets') ?>/img/illustrations/i19.png" srcset="<?= base_url('assets') ?>/img/illustrations/i19@2x.png 2x" alt="" /></figure>
            ...
            <div class="col-lg-4">
                <div class="px-md-15 px-lg-3">
                    <figure class="mb-6"><img class="img-fluid" src="<?= base_url('assets') ?>/img/illustrations/i18.png" srcset="<?= base_url('assets') ?>/img/illustrations/i18@2x.png 2x" alt="" /></figure>
                    <h3>3D Animation</h3>
...
<section class="wrapper bg-gradient-reverse-primary">
    <div class="container pb-14 pb-md-16">
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            <div class="col-lg-7">
                <figure><img class="img-auto" src="<?= base_url('assets') ?>/img/illustrations/i22.png" srcset="<?= base_url('assets') ?>/img/illustrations/i22@2x.png 2x" alt="" /></figure>
            </div>
            <!--/column -->
            <div class="col-lg-5">
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 gy-lg-0 mb-11">
            ...
            <div class="col-lg-8 mt-lg-2">
                <div class="row align-items-center counter-wrapper gy-6 text-center">
                    <div class="col-md-4">
                        <div class="icon btn btn-circle btn-lg btn-soft-primary disabled mb-4"> <i class="uil uil-presentation-check"></i> </div>
                        <h3 class="counter">1000+</h3>
                        <p>Completed Projects</p>
                    </div>
                    <!--/column -->
                    <div class="col-md-4">
                        <div class="icon btn btn-circle btn-lg btn-soft-primary disabled mb-4"> <i class="uil uil-user-check"></i> </div>
                        <h3 class="counter">50K+</h3>
                        <p>Happy Customers</p>
                    </div>
                    <!--/column -->
                    <div class="col-md-4">
                        <div class="icon btn btn-circle btn-lg btn-soft-primary disabled mb-4"> <i class="uil uil-trophy"></i> </div>
                ...
                <div class="swiper overflow-visible">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <figure class="rounded mb-7"><a href="./single-project.html"><img src="<?= base_url('assets') ?>/img/photos/sp1.jpg" srcset="<?= base_url('assets') ?>/img/photos/sp1@2x.jpg 2x" alt="" /></a></figure>
                        ...
                        <!--/.swiper-slide -->
                        <div class="swiper-slide">
                            <figure class="rounded mb-7"><a href="./single-project.html"><img src="<?= base_url('assets') ?>/img/photos/sp2.jpg" srcset="<?= base_url('assets') ?>/img/photos/sp2@2x.jpg 2x" alt="" /></a></figure>
                            <div class="project-details d-flex justify-content-center flex-column">
                                <div class="post-header">
                        ...
                        <!--/.swiper-slide -->
                        <div class="swiper-slide">
                            <figure class="rounded mb-7"><a href="./single-project.html"><img src="<?= base_url('assets') ?>/img/photos/sp3.jpg" srcset="<?= base_url('assets') ?>/img/photos/sp3@2x.jpg 2x" alt="" /></a></figure>
                            <div class="project-details d-flex justify-content-center flex-column">
                                <div class="post-header">
                        ...
                        <!--/.swiper-slide -->
                        <div class="swiper-slide">
                            <figure class="rounded mb-7"><a href="./single-project.html"><img src="<?= base_url('assets') ?>/img/photos/sp4.jpg" srcset="<?= base_url('assets') ?>/img/photos/sp4@2x.jpg 2x" alt="" /></a></figure>
                            <div class="project-details d-flex justify-content-center flex-column">
                                <div class="post-header">
                        ...
                        <!--/.swiper-slide -->
                        <div class="swiper-slide">
                            <figure class="rounded mb-7"><a href="./single-project.html"><img src="<?= base_url('assets') ?>/img/photos/sp5.jpg" srcset="<?= base_url('assets') ?>/img/photos/sp5@2x.jpg 2x" alt="" /></a></figure>
                            <div class="project-details d-flex justify-content-center flex-column">
                                <div class="post-header">
                        ...
                        <!--/.swiper-slide -->
                        <div class="swiper-slide">
                            <figure class="rounded mb-7"><a href="./single-project.html"><img src="<?= base_url('assets') ?>/img/photos/sp6.jpg" srcset="<?= base_url('assets') ?>/img/photos/sp6@2x.jpg 2x" alt="" /></a></figure>
                            <div class="project-details d-flex justify-content-center flex-column">
                                <div class="post-header">
                        ...
                        <div class="card-body">
                            ...
                            <blockquote class="icon mb-0">
                                ...
                                <div class="blockquote-details">
                                    <img class="rounded-circle w-12" src="<?= base_url('assets') ?>/img/avatars/te1.jpg" srcset="<?= base_url('assets') ?>/img/avatars/te1@2x.jpg 2x" alt="" />
                                    <div class="info">
                    ...
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <blockquote class="icon mb-0">
                                ...
                                <div class="blockquote-details">
                                    <img class="rounded-circle w-12" src="<?= base_url('assets') ?>/img/avatars/te2.jpg" srcset="<?= base_url('assets') ?>/img/avatars/te2@2x.jpg 2x" alt="" />
                                    <div class="info">
                    ...
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <blockquote class="icon mb-0">
                                ...
                                <div class="blockquote-details">
                                    <img class="rounded-circle w-12" src="<?= base_url('assets') ?>/img/avatars/te3.jpg" srcset="<?= base_url('assets') ?>/img/avatars/te3@2x.jpg 2x" alt="" />
                                    <div class="info">
                    ...
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <blockquote class="icon mb-0">
                                ...
                                <div class="blockquote-details">
                                    <img class="rounded-circle w-12" src="<?= base_url('assets') ?>/img/avatars/te4.jpg" srcset="<?= base_url('assets') ?>/img/avatars/te4@2x.jpg 2x" alt="" />
                                    <div class="info">
                                        <h5 class="mb-1">Coriss Ambady</h5>
                                        <p class="mb-0">Financial Analyst</p>
                                    </div>
                    ...
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <blockquote class="icon mb-0">
                                ...
                                <div class="blockquote-details">
                                    <img class="rounded-circle w-12" src="<?= base_url('assets') ?>/img/avatars/te5.jpg" srcset="<?= base_url('assets') ?>/img/avatars/te5@2x.jpg 2x" alt="" />
                                    <div class="info">
                    ...
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <blockquote class="icon mb-0">
                                ...
                                <div class="blockquote-details">
                                    <img class="rounded-circle w-12" src="<?= base_url('assets') ?>/img/avatars/te6.jpg" srcset="<?= base_url('assets') ?>/img/avatars/te6@2x.jpg 2x" alt="" />
                                    <div class="info">
